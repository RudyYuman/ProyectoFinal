...
namespace Dataacces
{
    public class daoSede : OracleConexion, Ioperaciones<SedeBO>
    {
        public string Actualizar(SedeBO dto)
        {
            ...
            try
            {
                using (OracleConnection cn = new OracleConnection(strOracle))
                {
                    ...
                    using (OracleCommand command = new OracleCommand("SP_UPDATE_SEDE", cn))
                    {
                        // cambiar por el nombre de los campos de la tabla que se esta trabajando
                        command.CommandType = System.Data.CommandType.StoredProcedure;
                        command.Parameters.Add(new OracleParameter("P_ID_SEDE", OracleType.VarChar)).Value = dto.ID_SEDE;
                        command.Parameters.Add(new OracleParameter("P_NOMBRE_SEDE", OracleType.VarChar)).Value = dto.NOMBRE_SEDE;
        ...
        public string Eliminar(int dto)
        {
            ...
            try
            {
                using (OracleConnection cn = new OracleConnection(strOracle))
                {
                    cn.Open();
                    //cambiar el nombre del store procedure
                    using (OracleCommand command = new OracleCommand("SP_DELETE_SEDE", cn))
                    {
                        // cambiar por el nombre de los campos de la tabla que se esta trabajando
                        command.CommandType = System.Data.CommandType.StoredProcedure;
                        command.Parameters.Add(new OracleParameter("P_ID_SEDE", OracleType.VarChar)).Value = dto;
                        command.Parameters.Add(new OracleParameter("P_RESULT", OracleType.VarChar, 50)).Direction = System.Data.ParameterDirection.Output;
                        command.ExecuteNonQuery();
                        result = Convert.ToString(command.Parameters["P_RESULT"].Value);
                    }
        ...
        public string Insertar(SedeBO dto)
        {
            ...
            try
            {
                using (OracleConnection cn = new OracleConnection(strOracle))
                {
                    cn.Open();
                    //cambiar el nombre del store procedure
                    using (OracleCommand command = new OracleCommand("SP_INSERT_SEDE", cn))
                    {
                        // cambiar por el nombre de los campos de la tabla que se esta trabajando
        ...
        public List<SedeBO> Listar()
        {
            ...
            List<SedeBO> list = new List<SedeBO>();
            SedeBO dto = null;
            try
            {
                ...
                using (OracleConnection cn = new OracleConnection(strOracle))
                {
                    cn.Open();
                    //cambiar el nombre del store procedure
                    using (OracleCommand command = new OracleCommand("select * from SEDE", cn))
                    {
                        ...
                        using (OracleDataReader dr = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
                        {
                            ...
                            {
                                dto = new SedeBO();
                                dto.ID_SEDE = Convert.ToInt32(dr["ID_SEDE"]);
                                dto.NOMBRE_SEDE = dr["NOMBRE_SEDE"].ToString();
                                list.Add(dto);
                            }
                        }
                    }
